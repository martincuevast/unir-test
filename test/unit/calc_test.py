...
class TestCalculate(unittest.TestCase):
    ...
    def test_sqrt_method_returns_correct_result(self):
        ...
        self.assertAlmostEqual(1.41421356237, self.calc.sqrt(2), delta=0.0000001)
    ...
    def test_log10_method_returns_correct_result(self):
        ...
        self.assertAlmostEqual(0.30102999566, self.calc.log10(2), delta=0.0000001)
    ...
    def test_divide_method_with_negative_numbers(self):
        self.assertEqual(-1, self.calc.divide(-2, 2))
        self.assertEqual(-1.5, self.calc.divide(-3, 2))
        self.assertEqual(1.5, self.calc.divide(-3, -2))
    ...
    def test_log10_method_with_large_numbers(self):
        self.assertAlmostEqual(9, self.calc.log10(1e9), delta=0.0000001)
